      ...
      <div className='flex justify-between p-4'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='icons flex justify-between mt-3'>
            ...
            <a href="https://www.wikipedia.org/"  style={{ textDecoration: 'none', color: 'white' }} target='_blank'><i className='fa-brands fa-phone'></i></a>
          </div>
        </div>
      </div>
<p className='text-center mt-3 text-white'>Copyrighe &copy; May 2024 Batch, Media Player. Built with React.</p>
    </div>
  )
}
